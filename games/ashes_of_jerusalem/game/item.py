...
def create_example_items():
    ...
    items.append(Weapon(
        ...
        image_path="../graphics/items/cruciform_sword.png",
        attack_bonus=15,
        value=200
    ))
    ...
    items.append(Weapon(
        name="Dagger",
        description="Small dagger. Deals less damage, but makes you faster",
        image_path="../graphics/items/dagger.png",
        attack_bonus=20,
        value=300
    ))
    ...
    items.append(Weapon(
        name="Spear",
        description="Long spear. Increases your attack range",
        image_path="../graphics/items/spear.png",
        attack_bonus=50,
        value=1000
    ))
    ...
    items.append(Consumable(
        name="Holy Water",
        description="Blessed by a priest. Heals 100 HP",
        image_path="../graphics/items/holy_water.png",
        effect_type="Heal",
        effect_amount=100,
        value=15,
        max_stack=10
    ...
    items.append(Consumable(
        ...
        image_path="../graphics/items/holy_bible.png",
    ...
    items.append(Armor(
        name="Crusaders Shield",
        description="Strong shield. It will protect you from enemies!",
        image_path="../graphics/items/crusaders_shield.png",
        defense_bonus=3,
        value=40
    ))
