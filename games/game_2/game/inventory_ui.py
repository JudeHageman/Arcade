...
class InventoryUI:
    ...
    def create_buttons(self):
        ...
        self.sort_buttons = [
            ...
            {'text': 'Equip', 'rect': pygame.Rect(self.x + 440, button_y, button_width, button_height), 'action': 'equip_item'},
    ...
    def draw_item_grid(self, panel):
        ...
        for row in range(self.grid_rows):
            for col in range(self.grid_cols):
                ...
                # Slot color (equipped weapon gets a gold highlight)
                is_equipped = (
                ...
                if index < len(self.inventory.items):
                    ...
                    if is_equipped:
                        eq_surf = self.desc_font.render("EQUIP", True, (255, 220, 50))
                        panel.blit(eq_surf, (slot_x + 3, slot_y + 3))
    ...
    def draw_item_details(self, panel, index):
        ...
        if hasattr(item, 'attack_bonus'):
            ...
            if self.character and self.character.equipped_weapon is item:
                panel.blit(self.desc_font.render("[ EQUIPPED ]", True, (255, 220, 50)), (details_x + 10, y_offset))
                y_offset += 25
    ...
    def draw_buttons(self, panel):
        ...
        for button in self.sort_buttons:
            if 'sort' in button['action']:
                button_color = (80, 80, 120)
            elif button['action'] == 'equip_item':
                button_color = (160, 130, 30) if selected_is_equipped else (80, 120, 80)
            else:
                button_color = (120, 80, 80)
        ...
        panel.blit(self.desc_font.render("Actions:", True, (200, 200, 200)), (440, 490))
