...
class Button:
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        ...
        get_scores_fn = self.level.get_current_scores )
...
class Game:
    ...
    def run(self):
        """Main game loop with Session integration"""
        ...
        def get_scores():
            ...
            return (self.level.player.exp, self.level.team_kills, self.level.player.team)
